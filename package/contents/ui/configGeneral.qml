...
KCM.SimpleKCM {
    ...
    Kirigami.FormLayout {
        ...
        QQC2.RadioButton {
            id: switchesPreviousDesktopRadio
            QQC2.ButtonGroup.group: currentDesktopSelectedGroup
            text: i18nc("option:check completes the sentence 'Selecting current activity/virtual desktop switches to the previous desktop'", "Switches to the previous desktop") // qmllint disable unqualified
            checked: root.cfg_currentDesktopSelected === 2
            onToggled: if (checked) root.cfg_currentDesktopSelected = 2;
        }
    }
}
